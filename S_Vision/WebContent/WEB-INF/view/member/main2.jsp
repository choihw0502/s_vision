...
<!-- 				<li><a href="crew.jsp">VISION 팀원 소개</a></li> -->
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="../WEB_INF/view/account/account.jsp"><img src="/images/account.png" id="imagepreview" style="width: 30px; height: 20px">&nbsp;&nbsp;계좌</a></li>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<p>
					...
					<a>|</a>  
					<a class="btn btn-default btn-lg" style="border-color: white;" href="/account/accountList?mem_id=elesex">1<br>계좌</a>
					<a>|</a>  
